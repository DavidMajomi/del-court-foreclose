...
if submit1:
    if uploaded_file:
        st.subheader("Processing this could take up to 20 minutes depending on file size")
        ...
        st.download_button(label="label", data=xlsx_data, file_name="data.xlsx", mime="application/vnd.ms-excel")
